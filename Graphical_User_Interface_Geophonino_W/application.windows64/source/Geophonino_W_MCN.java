...
public class Geophonino_W_MCN extends PApplet {
...
public void setup() {
  ...
  .setPosition(315,60).setColorValue(0).setFont(fontTex); 
  ...
  cp5.addTextlabel("StationStatus").setText("2\u00ba Station positions, date and time")
  .setPosition(50,100).setColorValue(0).setFont(fontTit);
  
   cp5.addTextlabel("txtNameStFile").setText("Station positions file name: ")
  ...
  cp5.addButton("Get configuration")
    ...
    cp5.addTextlabel("txtGain").setText("Amplification (Ltb5):")
  .setPosition(315,405).setColorValue(0).setFont(fontTex); 
  
  ddlGainLtb = cp5.addDropdownList("gainLtb").setPosition(430, 420);
  ddlGainLtb.addItem("0 V/V", 0);
  ddlGainLtb.addItem("1 V/V", 1);
  ddlGainLtb.addItem("2 V/V", 2);  
  ddlGainLtb.addItem("5 V/V", 3);
  ddlGainLtb.addItem("10 V/V", 4);
  ddlGainLtb.addItem("20 V/V", 5);
  ddlGainLtb.addItem("50 V/V", 6);
  ddlGainLtb.addItem("100 V/V", 7);
  ddlGainLtb.setIndex(5);
 ...
 cp5.addTextlabel("txtAmplification").setText("Amplification (Arduino):")
  .setPosition(295,370).setColorValue(0).setFont(fontTex); 
  
  ddlGain = cp5.addDropdownList("x").setPosition(430, 385);
  ddlGain.addItem("1 V/V", 1);
  ddlGain.addItem("2 V/V", 2);
  ddlGain.addItem("4 V/V", 3);  
  customizeDl(ddlGain);
  ddlGain.setIndex(0);
...
public void customizeDl(DropdownList ddl) {
  // Format DropDownList
  ddl.enableCollapse();
...
public void controlEvent(ControlEvent theEvent) 
{
  ...
  else if (theEvent.isController()) 
  {
    ...
    case(1): //Connect with Geophonino-W in the seleccted port
         int portSel=PApplet.parseInt(ddlCom.getValue());//Get selected port
         numActiveSt= PApplet.parseInt(cp5.get(Textfield.class,"numSt").getText());
         println(portSel);
         if (portSel==0)
         {
    ...
    case(3): //Send data acquisition configuration to Geophonino-W
      ...
      duration= PApplet.parseInt(cp5.get(Textfield.class,"dura").getText());
      ...
      int srSel=PApplet.parseInt(ddlSr.getValue());
      int gainSel=PApplet.parseInt(ddlGain.getValue());
      int gainLtb=PApplet.parseInt(ddlGainLtb.getValue());
      int hour=PApplet.parseInt(hours);
      int minute=PApplet.parseInt(minutes);
      int second=PApplet.parseInt(seconds);
...
public void serialEvent(Serial myPort) 
{
    ...
    { 
      ...
      if(val.equals("adq_now_ok"))
        ...
        if(val.indexOf("adq_now_ok")>-1)
        {
           ...
           count=PApplet.parseInt(val.substring(10,val.length())); //Update counter for progress bar
           if (count==duration)
           {
      ...
      if(val.indexOf("sendF_size")>-1) 
       {
           println("sendF_size");
           tamFile=PApplet.parseInt(val.substring(10,val.length()));
           println(tamFile);
       }       
      if(val.equals("sendF_now")) 
       ...
       {  // Set Station status text value
          ...
          stationId=PApplet.parseInt(val.substring(15,17));
          if (stationId==0)
            stationId=PApplet.parseInt(val.substring(15,16));
       ...
       {  //Set Station data values
           println(val);
          stationId=PApplet.parseInt(val.substring(11,13));
          if (stationId==0)
             stationId=PApplet.parseInt(val.substring(11,12));
       ...
       {  //Set Station data values
          ...
          stationId=PApplet.parseInt(val.substring(18,20));
          println(stationId);
          if (stationId==0)
            stationId=PApplet.parseInt(val.substring(18,19));
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Geophonino_W_MCN" };
    if (passedArgs != null) {
